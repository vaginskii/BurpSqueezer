...
| fp:d776 | <14 chars> [fp:d776] | 14 | 3.81 | 0.54 | 2 | 3.3% | 1 | no | yes | - | GET /api/users/{id} (req path) [#26], GET /api/users/{id} (resp body.id) [#26] |
| fp:c943 | <14 chars> [fp:c943] | 14 | 3.81 | 0.54 | 2 | 3.3% | 1 | no | yes | - | GET /api/users/{id} (req path) [#27], GET /api/users/{id} (resp body.id) [#27] |

### Multi-Data-Flow Chains

- **fp:a5a2** c1f4a9…0c31 [fp:a5a2] (32 chars) — 14 hops across 11 endpoints, score 1.26
...
|---|---|---|---|---|---|---|---|---|
| POST /api/channels/chn_2Vb6Xy8Qs4/messages | 1 | 201 | 0.85 | object_write | - | text | author, id | fp:2ba4, fp:a5a2, fp:bdc4 |
| POST /api/workspaces/wks_8Hq2Lm4Rt9/invites | 1 | 201 | 0.84 | object_write | - | email | invite_id | fp:6b94, fp:a5a2, fp:f0cd |
| DELETE /api/invites/inv_9Tk1Nc7Rw3 | 1 | 200 | 0.82 | object_write | - | - | id, state | fp:6b94, fp:a5a2 |
| POST /api/auth/session | 1 | 201 | 0.74 | auth | - | challenge_id, proof | access_token, user.id, workspace.id | fp:2ba4, fp:4681, fp:a5a2, fp:f0cd |
| POST /api/auth/challenge | 1 | 200 | 0.57 | auth | - | login | challenge_id, ttl | fp:4681 |
| GET /api/workspaces/wks_8Hq2Lm4Rt9/members | 2 | 200 (2) | 0.57 | object_read | page | - | items[].id | fp:2ba4, fp:a5a2, fp:f0cd |
| GET /api/workspaces/wks_8Hq2Lm4Rt9/channels | 1 | 200 | 0.57 | object_read | - | - | items[].id | fp:a5a2, fp:bdc4, fp:f0cd |
| GET /api/users/{id} | 3 | 200 (3) | 0.57 | object_read | - | - | id | fp:2ba4, fp:a5a2, fp:c943, fp:d776 |
| GET /api/invites/inv_9Tk1Nc7Rw3 | 1 | 200 | 0.55 | object_read | - | - | id, state | fp:6b94, fp:a5a2 |
| GET /api/me | 1 | 200 | 0.55 | local_identity | - | - | id, name | fp:2ba4, fp:a5a2 |
| GET /api/workspaces/wks_8Hq2Lm4Rt9 | 1 | 200 | 0.55 | object_read | - | - | id, plan | fp:a5a2, fp:f0cd |
| GET /api/channels/chn_2Vb6Xy8Qs4/messages | 1 | 200 | 0.53 | object_read | limit | - | items[].id | fp:a5a2, fp:bdc4 |
...
| GET /api/announcements | 1 | 200 | 0.01 | since | - | items | - |
| GET /api/branding | 1 | 200 | 0.01 | domain | - | logo | - |
| GET /api/public/legal | 1 | 200 | 0.01 | doc | - | rev | - |

### Sequences

| sequence | support | linked values |
|---|---|---|
| GET /api/users/{id} → GET /api/users/{id} | 2 | fp:2ba4, fp:a5a2, fp:c943, fp:d776 |
| GET /api/users/{id} → POST /api/workspaces/wks_8Hq2Lm4Rt9/invites | 1 | fp:2ba4, fp:6b94, fp:a5a2, fp:c943, fp:d776, fp:f0cd |
| POST /api/channels/chn_2Vb6Xy8Qs4/messages → GET /api/users/{id} | 1 | fp:2ba4, fp:a5a2, fp:bdc4, fp:c943, fp:d776 |
| GET /api/workspaces/wks_8Hq2Lm4Rt9/members → GET /api/workspaces/wks_8Hq2Lm4Rt9/channels | 1 | fp:2ba4, fp:a5a2, fp:bdc4, fp:f0cd |
| POST /api/auth/session → GET /api/me | 1 | fp:2ba4, fp:4681, fp:a5a2, fp:f0cd |
| POST /api/auth/challenge → POST /api/auth/session | 1 | fp:2ba4, fp:4681, fp:a5a2, fp:f0cd |
| GET /api/channels/chn_2Vb6Xy8Qs4/messages → POST /api/channels/chn_2Vb6Xy8Qs4/messages | 1 | fp:2ba4, fp:a5a2, fp:bdc4 |
| GET /api/workspaces/wks_8Hq2Lm4Rt9 → GET /api/workspaces/wks_8Hq2Lm4Rt9/members | 1 | fp:2ba4, fp:a5a2, fp:f0cd |
| GET /api/workspaces/wks_8Hq2Lm4Rt9/channels → GET /api/channels/chn_2Vb6Xy8Qs4/messages | 1 | fp:a5a2, fp:bdc4, fp:f0cd |
| POST /api/workspaces/wks_8Hq2Lm4Rt9/invites → GET /api/invites/inv_9Tk1Nc7Rw3 | 1 | fp:6b94, fp:a5a2, fp:f0cd |
| GET /api/me → GET /api/workspaces/wks_8Hq2Lm4Rt9 | 1 | fp:2ba4, fp:a5a2, fp:f0cd |
| GET /api/invites/inv_9Tk1Nc7Rw3 → DELETE /api/invites/inv_9Tk1Nc7Rw3 | 1 | fp:6b94, fp:a5a2 |
